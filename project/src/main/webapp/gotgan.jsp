...
.sidebar .tags ul li a:hover {
  ...
  <body>
    ...
    <section class="call-to-action" >
      <div class="container" style="color: #7a7a7a;">
        <div class="row">
          <div class="col-lg-12">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Lifestyle</span>
                      <a href="post-details.jsp"><h4>Donec tincidunt leo</h4></a>
                      <ul class="post-info">
                ...
                <div class="col-lg-6">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Lifestyle</span>
                      <a href="post-details.jsp"><h4>Suspendisse et metus</h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>
                ...
                <div class="col-lg-6">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span>Lifestyle</span>
                      <a href="post-details.jsp"><h4>Mauris ac dolor ornare</h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>
